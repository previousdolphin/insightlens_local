...
InsightLens is a local web application that turns your phone into a high-quality, real-time document camera. It streams video from your phone's camera (or really any device that csn connect to the local site and has a camera) directly to an immersive, full-screen viewer in your laptop/desktop/tablets browser over your local Wi-Fi network.
